...
WebUI.verifyElementText(findTestObject('Page_SAP/span_Standard Order 183427 has been saved'), "Standard Order " +GlobalVariable.Sales_Order+" has been saved.")

WebUI.click(findTestObject('Object Repository/Page_SAP/div_ExitHelp'))

WebUI.click(findTestObject('Object Repository/Page_Trial Center/Span_UT'))
