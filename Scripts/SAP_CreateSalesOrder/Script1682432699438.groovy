...
WebUI.setText(findTestObject('Object Repository/Page_Trial Center/input_All_search'), 'manage sales orders')
...
WebUI.click(findTestObject('Object Repository/Page_Create Standard Order Overview/span_17100007'))
